...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul class="uk-grid">
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?> uk-width-large-1-3 uk-width-medium-1-2 uk-width-small-1-1">
      ...
      <div class="moduleItemIntrotext">
	      ...
	      <a class="moduleItemImage" href="<?php echo $item->link; ?>" title="<?php echo JText::_('K2_CONTINUE_READING'); ?> &quot;<?php echo K2HelperUtilities::cleanHtml($item->title); ?>&quot;">
	      	<img style="float:left;width:80px;height:60px;margin: 7px 10px 15px 0;" src="<?php echo $item->image; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>" />
	      </a>
	      <?php endif; ?>
      ...
      <?php echo $item->event->K2AfterDisplayContent; ?>
			...
			<a class="moduleItemTitle" style="display: block;font-size: 14px;line-height: 1.4;font-weight: bold;color:#000" href="<?php echo $item->link; ?>"><?php echo $item->title; ?></a>
			<?php endif; ?>
      ...
      <span class="moduleItemDateCreated" style="font-size:14px;">Published:
			<?php echo JHTML::_('date', $item->created, 'n M Y'); ?></span>
      <?php endif; ?>
