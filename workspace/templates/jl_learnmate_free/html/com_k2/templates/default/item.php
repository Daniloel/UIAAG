...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php //if( $this->item->params->get('itemFontResizer') || ($this->item->params->get('itemPrintButton') && !JRequest::getInt('print')) || ($this->item->params->get('itemEmailButton') && !JRequest::getInt('print')) || ($this->item->params->get('itemEmailButton') && !JRequest::getInt('print')) || ($this->item->params->get('itemSocialButton') && !is_null($this->item->params->get('socialButtonCode', NULL))) || ($this->item->params->get('itemVideoAnchor') && !empty($this->item->video)) || ($this->item->params->get('itemCommentsAnchor') && $this->item->params->get('itemComments') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) || ($this->item->params->get('comments') == '1')) ) { ?>

	<?php if( $this->item->params->get('itemFontResizer') || ($this->item->params->get('itemPrintButton') && !JRequest::getInt('print')) || ($this->item->params->get('itemEmailButton') && !JRequest::getInt('print')) || ($this->item->params->get('itemEmailButton') && !JRequest::getInt('print')) || ($this->item->params->get('itemSocialButton') && !is_null($this->item->params->get('socialButtonCode', NULL))) || ($this->item->params->get('itemVideoAnchor') && !empty($this->item->video)) || ($this->item->params->get('itemCommentsAnchor') && $this->item->params->get('itemComments') && ( ($this->item->params->get('comments') == '2' && !$this->user->guest) )) ) { ?>
	...
	*/
	...
	<div class="itemComments">
		...
		<ul class="itemCommentsList">
			...
			<div class="comment-img col-sm-2">
